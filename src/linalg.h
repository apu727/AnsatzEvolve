...
#warning Explicit AVX512POPCount
    ...
    i = _mm512_sub_epi64(i, (_mm512_and_epi64(_mm512_srli_epi64(i, 1), _mm512_set1_epi64(0x5555555555555555))));        // add pairs of bits
    i = _mm512_and_epi64(i, _mm512_set1_epi64(0x3333333333333333)) + _mm512_and_epi64(_mm512_srli_epi64(i, 2), _mm512_set1_epi64(0x3333333333333333));  // quads
    i = _mm512_and_epi64(_mm512_add_epi64(i, _mm512_srli_epi64(i, 4)), _mm512_set1_epi64(0x0F0F0F0F0F0F0F0F));        // groups of 8
    i = _mm512_mullox_epi64(i,_mm512_set1_epi64(0x0101010101010101));                        // horizontal sum of bytes
    return  _mm512_srli_epi64(i, 56);               // return just that top byte
}
#endif
#ifndef popcount
...
#warning Explicity uint64_t popcount
    ...
    i *= 0x0101010101010101;                        // horizontal sum of bytes
    return  i >> 56;               // return just that top byte (after truncating to 32-bit even when int is wider than uint64_t)
}
#endif
